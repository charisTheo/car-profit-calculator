...
const fetchRatesFromEurobank = async ({from, to}) => {
  try {
    ...
    const response = await fetch(`https://3n4jvs3ouj3x3xkgjx46la75ve0oszff.lambda-url.eu-west-2.on.aws/?secret=afekjf902330QJR]QR0Q3&url=https://www.eurobank.cy/api/Calculators/exchangeFetchData`, {
      method: "POST",
      body
    });
